...
<html lang="[@T[localization:<language full='true' />]@T]" id="" ng-app="">
  <head>
    ...
    <link rel="canonical" href="[@T[link:<relative parammode='explicit' path='~/careers/diversity.aspx' />]@T]">
    <link rel="stylesheet" type="text/css" href="//cloud.typography.com/7914312/697366/css/fonts.css">
    <title>[@L[cds.sales/gd/careers/diversity:MetaTitle]@L]</title>
    <meta name="description" content="[@L[cds.sales/gd/careers/diversity:MetaTitle]@L]">
    <meta name="keywords" content="[@L[cds.sales/gd/careers/diversity:MetaTitle]@L]"> 

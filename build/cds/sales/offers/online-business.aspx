...
<html lang="[@T[localization:<language full='true' />]@T]" id="" ng-app="">
  <head>
    ...
    <meta name="twitter:image:src" content="[@T[link:<imageroot />]@T]fos/sales/themes/scotty/offers/online-business/img/og_got_1200x630.jpg">[@P[webControl:<Data assembly="App_Code" type="WebControls.PresentationCentral.Item"><Parameters><Parameter key="Manifest" value="salesheader" /><Parameter key="Split" value="brand2.0" /><Parameter key="Name" value="css" /></Parameters></Data>]@P]
  ...
  <body ng-controller="">
    ...
    <section id="marquee">
      <atlantis:webstash type="css">
        <style>
          ...
          #marquee .search-message {display: none; text-transform: none; }
      ...
      <section id="default-marquee-view" class="bg-green-official js-marquee-section">
        <div class="container main-marquee">
          ...
          <form id="defaultmarqueeviewform">
            <div class="row">
              <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-12 offer-search-box">
                <div class="input-group">
                  <input type="text" placeholder="[@L[cds.sales/offers/online-business:32573-domain-search-placeholder]@L]" name="domainToCheck" autocomplete="off" class="form-control input-lg search-form-input searchInput helveticafont"/><span class="input-group-btn">
            ...
            <script>
              ...
              $(document).ready(function(){
                ...
                var tldErr = defaultmarqueeviewform.getParameterByName('tldRegErr'),
                    ...
                    dupErr = defaultmarqueeviewform.getParameterByName('dppError');
                ...
                if(dppHasError) {
                  ...
                  switch(dupErr){
                    ...
                    default:
                      var $failArea = $('#defaultmarqueeviewform .domain-eligibility-fail'), 
                          html = $failArea.html();
      ...
      <section id="domain-not-available-marquee-view" class="js-marquee-section">
        <div class="bg-green-official">
          <div class="container">
            ...
            <form id="domainnotavailablemarqueeviewform">
              <div class="row">
                <div class="col-md-12">
    ...
    <atlantis:webstash type="css">
      <style>
        ...
        .key-benefits-wrap[class*="bg-"]:not(.bg-gray-light) h2,
        .key-benefits-wrap[class*="bg-"]:not(.bg-gray-light) h3 {
          color: #fff;
        }
        .key-benefits-wrap[class*="bg-"]:not(.bg-gray-light) .btn-white-outline:hover,
        .key-benefits-wrap[class*="bg-"]:not(.bg-gray-light) a.btn-white-outline:hover,
        .key-benefits-wrap[class*="bg-"]:not(.bg-gray-light) .btn-white-outline:focus,
        .key-benefits-wrap[class*="bg-"]:not(.bg-gray-light) a.btn-white-outline:focus {
          color: #ef6c0f !important;
        }
        .key-benefits-wrap[class*="bg-"]:not(.bg-gray-light) a,
        .key-benefits-wrap[class*="bg-"]:not(.bg-gray-light) a:visited,
        .key-benefits-wrap[class*="bg-"]:not(.bg-gray-light) a:hover {
          color: #fff;
        }
                    ...
                    <div class="col-sm-12">
                      <div class="row text-center disclaimer-mark"> 
                        ...
                        <p data-tokenize="[@T[multipleproductprice:<list productidlist="464069|101|40972" period="monthly" promocode="0" />]@T]" class="disclaimer">[@L[cds.sales/offers/online-business:32573-godaddy-ols-text-price-disclaimer]@L] 
                          <button data-ci-workaround="95735" class="btn-link see-ols-disclaimer-link">[@L[cds.sales/offers/online-business:32573-godaddy-ols-text-price-disclaimer-link]@L]</button> 
                          ##if(countrySiteAny(uk))

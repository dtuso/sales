...
.pro-plans .sf-tipper-target {
  ...
  <body>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
              <div class="you-get-wrapper">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <p class="text-center"><span class="headline-secondary domain-text">[@L[cds.sales/offers/online-business:32573-top-banner-image-domain]@L]</span></p>
                  </div>
                  <div class="col-md-4">
                    <p class="text-center"><span class="headline-secondary website-text">[@L[cds.sales/offers/online-business:32573-top-banner-image-website]@L]</span></p>
                  </div>
                  <div class="col-md-4">
                    <p class="text-center"><span class="headline-secondary email-text">[@L[cds.sales/offers/online-business:32573-top-banner-image-email]@L]</span><span class="powered-by-text">[@L[cds.sales/offers/online-business:32573-powered-by-mso365]@L]</span></p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <section id="wsb-only-choice" class="bg-green-official-light">
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-12 button-margin">
            <button id="wsb-only-designs-btn" data-toggle="bsModal" data-target="#g-modal" class="btn btn-md btn-block btn-primary">[@L[cds.sales/offers/online-business:32573-view-designs-button]@L]</button>
            <button data-toggle="bsModal" data-target="#g-modal" style="display: none;" class="btn btn-primary view-all btn-lg">
              <p> <style>
  ...
  #templates .templates-slider>ul li .hover{background:url([@T[link:<imageroot />]@T]fos/wsb/rebrand/img/wsb_templates_hover.jpg) transparent;position:absolute;height:100%;width:100%;display:none}.templates-dialog{left:0;margin:10px;position:relative;width:auto;height:706px;z-index:1050}
                ...
                <div style="" class="two-up-text-wrap ">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="row">
                        <div class="col-sm-12 button-margin">
                          <button id="wsb-designs-btn" data-toggle="bsModal" data-target="#g-modal" class="btn btn-md btn-block btn-primary">[@L[cds.sales/offers/online-business:32573-view-designs-button]@L]</button>
                          <button data-toggle="bsModal" data-target="#g-modal" style="display: none;" class="btn btn-primary view-all btn-lg"></button>
                          <p> <style>
  #faqSlider{margin:20px 0}#faqSlider .gd-swipe{box-sizing:border-box;border:1px solid #ededed;background-color:#ededed;color:#595959;margin:0 auto;position:relative;width:1000px}#faqSlider .gd-swipe-wrap .gd-swipe-item{box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:40px 70px 50px;line-height:1.5;*width:860px!important}
  #faqSlider .gd-swipe-head,#faqSlider .gd-swipe-head h1,#faqSlider .gd-swipe-head h2{color:#222;font-size:20px}#faqSlider .gd-swipe-body p{margin-bottom:15px;font-size:14px;line-height:24px}#faqSlider .gd-swipe-body p span{font-weight:700}.arrow-left:hover,.arrow-right:hover{background-color:#ededed;-webkit-transition:all .3s ease-in-out;-moz-transition:all .3s ease-in-out;-ms-transition:all .3s ease-in-out;-o-transition:all .3s ease-in-out;transition:all .3s ease-in-out}
  #faqSlider a.arrow-left,#faqSlider a.arrow-right,#templates .arrow-left,#templates .arrow-right{top:42%}#templates{position:relative;padding-top:35px;margin:40px auto 0;width:1000px;clear:both}#templates>h2{display:block;text-align:center;font-size:36px;color:#333;margin:0 auto}

...
.mid-page-nav .price span {
  ...
  #templates .templates-slider>ul li .hover{background:url([@T[link:<imageroot />]@T]fos/wsb/rebrand/img/wsb_templates_hover.jpg) transparent;position:absolute;height:100%;width:100%;display:none}.templates-dialog{left:0;margin:10px;position:relative;width:1000px;height:706px;z-index:1050}

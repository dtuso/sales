            ...
            <form id="domainSearchViewForm">
              ...
              <div class="row domain-search-messaging-row">
                <div class="col-xs-12 col-sm-12">
                  ...
                  <div style="display:none" data-tokenize="[@T[link:<external linktype="carturl" path="/basket.aspx" ><param name="ci" value="97060" /></external>]@T]" class="search-message headline-primary speech-shape-upsidedown speech-shape-upsidedown-orange dup-domain-fail"><mark class='selected-domain-name-display'></mark> is already in your cart. To use it with this offer, please go to your <a href='{0}'>cart</a>, delete your domain and search again.</div>
                </div>
              </div>
            </form>
          </div>
      ...
      <div id="domain-selected-view" style="display:none" class="js-domain-search-wizard-section">
        <div id="selected-domain" class="container">
          ...
          <div style="padding-top:30px;padding-bottom:10px" class="row">
            <div class="col-xs-12 col-sm-12 text-center">
              <btn data-ci="97069" class="btn btn-primary btn-search-again btn-lg uppercase">[@L[cds.sales/getonline:search-again]@L]</btn>
            </div>
          </div>
          <div style="padding-top:30px;padding-bottom:10px" class="row">
            <div class="col-xs-12 col-sm-12 text-center">

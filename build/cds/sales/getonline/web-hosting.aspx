      ...
      <div id="domain-available-view" style="display:none" class="js-domain-search-wizard-section">
        <div class="container">
          ...
          <div id="available-domain" class="row bg-light">
            ...
            <div class="col-md-3 white">
              <button data-ci="" class="btn btn-primary select-and-continue available-domain-name uppercase">[@L[cds.sales/getonline:choose-select-button]@L]</button>
        ...
        <div class="container other-domains spin-container">
          <div class="row">
            <div class="col-md-12">
              ...
              <h6 class="results-list-heading-text"> <span data-result-count-template="[@L[cds.sales/getonline:number-of-number-results]@L]" class="spin-counts"></span>
                <button data-ci="" class="btn btn-link view-all-button">[@L[cds.sales/getonline:view-all-results]@L]</button>
              </h6>
            </div>
          </div>
          ...
          <div class="row show-more-section">
            <div class="col-md-12">
              <h6 style="margin-top:10px" class="text-center"><span data-ci="" class="clickable-show-more"><span>[@L[cds.sales/getonline:see-more-results]@L]</span><span class="show-more-arrow"></span></span></h6>
            </div>
          </div>
          <div style="padding-top:30px;padding-bottom:10px" class="row search-again-section">
            <div class="col-md-12 text-center">
              <btn data-ci="" class="btn btn-primary btn-search-again btn-lg text-center uppercase">[@L[cds.sales/getonline:search-again]@L]</btn>
            </div>
          </div>
          <div class="row bubble-row product-section">
            <div class="col-xs-10 col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-4 bubble white">
      ...
      <div id="domain-selected-view" style="display:none" class="js-domain-search-wizard-section">
        <div id="selected-domain" class="container">
          ...
          <div style="padding-top:30px;padding-bottom:10px" class="row">
            <div class="col-xs-12 col-sm-12 text-center">
              <btn data-ci="" class="btn btn-primary btn-search-again btn-lg uppercase">[@L[cds.sales/getonline:search-again]@L]</btn>
            </div>
          </div>
          <div style="padding-top:30px;padding-bottom:10px" class="row">
            <div class="col-xs-12 col-sm-12 text-center">
              <btn data-ci="" class="btn btn-primary btn-see-bundle btn-lg uppercase">[@L[cds.sales/getonline:see-other-products]@L]</btn>
              <btn data-ci="" class="btn btn-purchase btn-plan btn-lg uppercase p4p">[@L[cds.sales/getonline:checkout-now]@L]</btn>
            </div>
          </div>
          <div class="row bubble-row product-section">
            <div class="col-xs-10 col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-4 bubble white">

...
<html lang="[@T[localization:<language full='true' />]@T]" id="" ng-app="">
  <head>
    ...
    <title>[@L[cds.sales/getonline:hosting-page-title]@L]</title>
    ...
    <atlantis:webstash type="js">
      <script>
        var offerInfo = {
          businessName: "",
          landingPage: "getonline/web-hosting.aspx",
          ...
          pricing: {
            ...
            renewal_monthly: "[@T[productprice:<list productid='32051' period='monthly'></list>]@T]",
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-8 col-sm-offset-4 products">
            ...
            <div class="column website"><img src="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/img-features-hosting.png" class="img-responsive center-block">
              <h3 class="text-center">[@L[cds.sales/getonline:hosting-product-name]@L]</h3>
              <p>[@L[cds.sales/getonline:hosting-product-get-it-now-description]@L]</p>
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <form id="domainSearchViewForm">
                ...
                <div class="col-xs-12 col-sm-12 offer-search-box">
                  <div class="input-group">
                    <input type="text" placeholder="[@L[cds.sales/getonline:placeholder]@L]" name="domainToCheck" autocomplete="off" class="form-control input-lg search-form-input searchInput helveticafont"/><span class="input-group-btn">
                      <button type="button" name="searchButton" data-ci="97047" class="btn btn-primary btn-lg offer-search-btn">[@L[cds.sales/getonline:search]@L]</button></span>
                  </div>
                </div>
              </div>
              <div class="row domain-search-messaging-row">
                <div class="col-xs-12 col-sm-12">
                  ...
                  <div style="display:none" data-tokenize="[@T[link:<external linktype="carturl" path="/basket.aspx" ><param name="ci" value="97048" /></external>]@T]" class="search-message headline-primary speech-shape-upsidedown speech-shape-upsidedown-orange dup-domain-fail">[@L[cds.sales/getonline:domain-already-in-cart-checkout-or-search]@L]</div>
                </div>
              </div>
            </form>
          </div>
      ...
      <div id="domain-available-view" style="display:none" class="js-domain-search-wizard-section">
            ...
            <form id="domainAvailableViewSearchForm">
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-12 offer-search-box">
                  <div class="input-group">
                    <input type="text" placeholder="[@L[cds.sales/getonline:placeholder]@L]" name="domainToCheck" autocomplete="off" class="form-control input-lg search-form-input searchInput helveticafont"/><span class="input-group-btn">
                      <button type="button" name="searchButton" data-ci="97049" class="btn btn-primary btn-lg offer-search-btn">[@L[cds.sales/getonline:search]@L]</button></span>
                  </div>
                </div>
              </div>
              <div class="row domain-search-messaging-row">
        ...
        <div id="recommended-domain" class="container">
          ...
          <div class="row bg-light">
            ...
            <div class="col-md-3 white">
              <button data-ci="97050" class="btn btn-primary select-and-continue available-domain-name uppercase">[@L[cds.sales/getonline:choose-select-button]@L]</button>
        ...
        <div class="container other-domains spin-container">
          <div class="row">
            <div class="col-md-12">
              ...
              <h6 class="results-list-heading-text"> <span data-result-count-template="[@L[cds.sales/getonline:number-of-number-results]@L]" class="spin-counts"></span>
                <button data-ci="97051" class="btn btn-link view-all-button">[@L[cds.sales/getonline:view-all-results]@L]</button>
              </h6>
            </div>
          </div>
          ...
          <div class="row show-more-section">
            <div class="col-md-12">
              <h6 style="margin-top:10px" class="text-center"><span data-ci="97051" class="clickable-show-more"><span>[@L[cds.sales/getonline:see-more-results]@L]</span><span class="show-more-arrow"></span></span></h6>
            </div>
          </div>
          <div style="padding-top:30px;padding-bottom:10px" class="row search-again-section">
            <div class="col-md-12 text-center">
              <btn data-ci="97052" class="btn btn-primary btn-search-again btn-lg text-center uppercase">[@L[cds.sales/getonline:search-again]@L]</btn>
            </div>
          </div>
        </div>
      </div>
            ...
            <form id="domainNotAvailableViewSearchForm">
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-12 offer-search-box">
                  <div class="input-group">
                    <input type="text" placeholder="[@L[cds.sales/getonline:placeholder]@L]" name="domainToCheck" autocomplete="off" class="form-control input-lg search-form-input searchInput helveticafont"/><span class="input-group-btn">
                      <button type="button" name="searchButton" data-ci="97053" class="btn btn-primary btn-lg offer-search-btn">[@L[cds.sales/getonline:search]@L]</button></span>
                  </div>
                </div>
              </div>
              <div class="row domain-search-messaging-row">
        ...
        <div class="container other-domains spin-container">
          <div class="row">
            <div class="col-md-12">
              ...
              <h6 class="results-list-heading-text"> <span data-result-count-template="[@L[cds.sales/getonline:number-of-number-results]@L]" class="spin-counts"></span>
                <button data-ci="97055" class="btn btn-link view-all-button">[@L[cds.sales/getonline:view-all-results]@L]</button>
              </h6>
            </div>
          </div>
          <div style="margin-top:10px" class="spin-results"></div>
          ...
          <div class="row show-more-section">
            <div class="col-md-12">
              <h6 style="margin-top:10px" class="text-center"><span data-ci="97055" class="clickable-show-more"><span>[@L[cds.sales/getonline:see-more-results]@L]</span><span class="show-more-arrow"></span></span></h6>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="domain-selected-view" style="display:none" class="js-domain-search-wizard-section">
        <div id="selected-domain" class="container">
          ...
          <div style="padding-top:30px;padding-bottom:10px" class="row">
            <div class="col-xs-12 col-sm-12 text-center">
              <btn data-ci="97045" class="btn-search-again"><img src="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/img-search-glass.png"><span>[@L[cds.sales/getonline:search-again]@L]</span></btn>
            </div>
          </div>
          <div style="padding-top:30px;padding-bottom:10px" class="row">
            <div class="col-xs-12 col-sm-12 text-center">
              <btn data-ci="97057" class="btn btn-primary btn-see-bundle btn-lg uppercase">[@L[cds.sales/getonline:see-other-products]@L]</btn>
              <btn data-ci="97058" class="btn btn-purchase btn-plan btn-lg uppercase p4p">[@L[cds.sales/getonline:checkout-now]@L]</btn>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-10 col-sm-offset-1"><img src="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/img-features-hosting.png" class="img-responsive center-block">
            <h2 class="text-center">[@L[cds.sales/getonline:hosting-product-name]@L]</h2>
            <h4 class="text-center">[@L[cds.sales/getonline:hosting-product-description]@L]</h4>
            <div style="width:auto;display:table;margin:40px auto;max-width:900px" class="product-summary text-center">
              <div class="row">
                <div style="padding:0;margin-bottom:30px;" class="col-md-4 col-md-push-4">
                  ...
                  <div style="margin:auto;" class="text-center">[@L[cds.sales/getonline:hosting-product-info-www]@L]
                ...
                <div style="padding:0;margin-bottom:30px;" class="col-md-4 col-md-pull-4">
                  ...
                  <div class="row"> 
                    <div style="margin-top:-9%;padding:0;" class="col-md-offset-2 col-md-11 col-sm-12"><img src="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/hosting-flow/img-server2.png" style="margin:auto;" class="img-responsive">
                      <div style="margin:auto -10px;">[@L[cds.sales/getonline:hosting-product-info-company-hosting]@L]</div>
                    </div>
                  </div>
                </div>
            ...
            <p class="text-center">[@L[cds.sales/getonline:hosting-product-info-text]@L]</p>
          </div>
        </div>
    ...
    <section id="bottomGetItNow" class="bg-medium">
      <div class="container text-center">
        ...
        <div class="row">
          ...
          <div class="plus">+</div>
          <div class="column website"><img src="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/img-features-hosting.png" class="img-responsive center-block">
            <h3 class="got-subheader">[@L[cds.sales/getonline:hosting-product-name]@L]</h3>
          </div>
        </div>
        <div class="row">

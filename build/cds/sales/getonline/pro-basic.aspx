        ...
        <div class="col-xs-9 right-side">
          <div class="row text-center good-news-shape">
            <div class="head-wrapper">
              ...
              <h3>A proffesional design service for <span id="business-idea"></span> –  </h3>
              <h3>Starting at <span id="price-per-month"><span id="product-price">[@T[productprice:<current productid='6520' dropdecimal='false' period='monthly' htmlsymbol='false' negative='parentheses'/>]@T]</span>/mo*</span></h3>
            </div>
          </div>
          <div class="pro-wrapper">
            ...
            <div class="col-xs-6">
              ...
              <div class="col-xs-6">
                <p>Starting at <span id="price-per-month"><span id="product-price">[@T[productprice:<current productid='6520' dropdecimal='false' period='monthly' htmlsymbol='false' negative='parentheses'/>]@T]</span>/mo*</span></p>
              </div>
            </div>
          </div>
          <div class="container bottom">
            <div class="row">
              ...
              <div class="col-md-2"><div class='pro-computer'></div>
                <label class="h3 logo-label">PROFESSIONAL DESIGN SERVICES</label>
      ...
      <div class="container">
        <div class="row">
          <div style="margin-top:30px" class="text-center">
            ...
            <h3 style="margin-top:10px;margin-left:5%;margin-right:5%" class="uppercase">We have a professional design service for <span id="business-idea2"></span> starting at <span id="price-per-month"><span id="product-price">[@T[productprice:<current productid='6520' dropdecimal='false' period='monthly' htmlsymbol='false' negative='parentheses'/>]@T]</span>/mo*</span></h3>
          </div>
          <div class="pro-wrapper">
            <div class="col-xs-6"><div class='pro-computer'></div></div>
            <div class="col-xs-6">

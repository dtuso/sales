        ...
        <div style="margin-top:35px" class="row">
          ...
          <div style="padding-left:60px" class="col-xs-8 col-sm-6 products">
            ...
            <div class="header-text disclaimers"><small class="text-disclaimers">
                <button data-ci="97736" class="btn-link see-details-disclaimer-link">[@L[cds.sales/getonline:disclaimer-modal-title]@L]</button></small> 
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-8 col-sm-offset-2 text-center">
            <h2>[@L[cds.sales/getonline:pro-design-interview-header]@L]</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-12 text-center">
            <h3>[@L[cds.sales/getonline:pro-design-interview-header-text]@L]</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4">
            <div class="feature why-gd-world-leader"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-lazyload-source="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/ProShare.png" data-lazyload-watch="" data-lazyload-callback="undefined" data-lazyload-callbackAfter="undefined" alt="Clipboard" class="lazyload"/>
              <mark class="uppercase">[@L[cds.sales/getonline:pro-design-interview-step-1]@L]</mark>
              <h3>[@L[cds.sales/getonline:pro-design-interview-step-1-header]@L]</h3>
              <p>[@L[cds.sales/getonline:pro-design-interview-step-1-text]@L]</p>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="feature why-gd-support text-center"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-lazyload-source="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/ProWork.png" data-lazyload-watch="" data-lazyload-callback="undefined" data-lazyload-callbackAfter="undefined" alt="Design" class="lazyload"/>
              <mark class="uppercase">[@L[cds.sales/getonline:pro-design-interview-step-2]@L]</mark>
              <h3>[@L[cds.sales/getonline:pro-design-interview-step-2-header]@L]</h3>
              <p>[@L[cds.sales/getonline:pro-design-interview-step-2-text]@L]</p>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="feature why-gd-trust text-center"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-lazyload-source="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/ProExpand.png" data-lazyload-watch="" data-lazyload-callback="undefined" data-lazyload-callbackAfter="undefined" alt="Tools" class="lazyload"/>
              <mark class="uppercase">[@L[cds.sales/getonline:pro-design-interview-step-3]@L]</mark>
              <h3>[@L[cds.sales/getonline:pro-design-interview-step-3-header]@L]</h3>
              <p>[@L[cds.sales/getonline:pro-design-interview-step-3-text]@L]</p>
            </div>
          </div>
        </div>
    ...
    <section id="bottomGetItNow" class="bg-medium">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xs-6">
            <h3 class="product-name got-subheader">[@L[cds.sales/getonline:pro-design-product-name]@L]</h3>
            <p class="p1">[@L[cds.sales/getonline:pro-design-product-get-it-now-description]@L]</p>
            <button id="getItNowBottom" type="submit" data-ci="96311" class="btn btn-lg btn-purchase">[@L[cds.sales/getonline:get-it-now]@L]</button>
            <p class="p2">[@L[cds.sales/getonline:pro-design-product-call-us]@L]</p>
          </div>
        </div>
      </div>

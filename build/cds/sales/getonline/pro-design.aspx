...
<html lang="[@T[localization:<language full='true' />]@T]" id="" ng-app="">
  ...
  <body ng-controller="">
    ...
    <section id="design" class="product-section">
      <div class="container">
        <div class="row">
    ...
    <script>
      $(document).ready(function(){
           $('#external').click(function(){
              openPopUpWithParams("http://www.ourdesignexamples.com", "customweb_popup", "left=50,top=50,resizable=yes,scrollbars=yes,width=1000,height=950");
           });
      });

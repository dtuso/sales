...
<html lang="[@T[localization:<language full='true' />]@T]" id="" ng-app="">
  ...
  <body ng-controller="">
      ...
      <div class="container"><img src="https://img1.wsimg-com.ide/fos/sales/themes/montezuma/getonline/img/img-hero-guy.png" class="hero-guy hidden-xs">
        <div class="row">
          <div class="col-xs-12 col-sm-9 col-sm-offset-3 bubble">
            ...
            <h3 class="text-center">A professional design service for <mark class="business-name-display"></mark> – Starting at <mark id="product-price">[@T[productprice:<current productid='1023' dropdecimal='false' period='monthly' htmlsymbol='false' negative='parentheses'/>]@T]/mo*</mark></h3>
          </div>
        </div>
    ...
    <section id="bottomGetItNow" class="bg-medium">
      <div class="container">
        <h3 style="margin-top:10px;margin-left:5%;margin-right:5%" class="text-center">We have a professional design service for <mark><span class="business-name-display"></span></mark> starting at [@T[productprice:<current productid='1023' dropdecimal='false' period='monthly' htmlsymbol='false' negative='parentheses'/>]@T]/mo*</span></h3>

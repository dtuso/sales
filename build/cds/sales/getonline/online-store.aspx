      ...
      <div class="container"><img src="https://img1.wsimg-com.ide/fos/sales/themes/montezuma/getonline/img/img-hero-guy.png" class="hero-guy hidden-xs">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-9 col-sm-offset-3 products">
            ...
            <div class="column website"><img src="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/img-features-onlineStore.png" class="img-responsive center-block">
              ...
              <p>Easily create a site that lets you sell your stuff, accept credit cards and more.</p>
            </div>
            <div class="plus">+</div>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-9 col-sm-offset-3 cta">
            ...
            <button data-ci="96294" class="btn btn-purchase btn-lg center-block">Get It Now</button><small class="text-center price-token">*Bundle cost is {price_annual}/year and {renewal_annual}/year after the first year</small>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="row">
            ...
            <div class="video-info col-sm-4">
              <div class="video-marquee-info text-center">
                ...
                <button id="viewAllTemplates" style="margin:20px auto" data-toggle="modal" data-target="#g-modal" data-ci="96300" class="cta btn btn-default-dark btn-md uppercase">Watch Now</button>
=======
        <section data-youtube-id="rMF9d8-3WBA" class="video-marquee-wrapper">
          <div class="container">
            <div data-lazyload-source="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/img-onlinestore-monitor.png" data-ci="xxxxxx" class="lazyload video-marquee video-marquee-black full-video monitor"></div>
...
<<<<<<< HEAD
          ...
          <div class="container bottom">
            <div class="row">
              ...
              <div class="col-sm-4 text-center"><img src="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/img-features-onlineStore.png" class="img-responsive center-block">
                <h3 class="text-center">Online Store</h3>
              </div>
...
>>>>>>> eb903890a56c5a33c324c1b408789d1f79b05156
        ...
        <div class="row">
          <h3>[@T[multipleproductprice:<current productidlist="101|47902|464069" period="monthly" promocode="75315678"></current>]@T]/month for the first year*</h3>
          <button data-ci="96296" class="btn btn-primary btn-lg">Search Again</button>
          <button data-ci="96298" class="btn btn-purchase btn-lg">Get It Now</button><small>*Bundle cost is [@T[multipleproductprice:<current productidlist="101|47902|464069" period="yearly" promocode="75315678"></current>]@T]/year and [@T[multipleproductprice:<current productidlist="101|47902|464069" period="yearly"></current>]@T]/year after the first year</small>
        </div>
      </div>
    </section>

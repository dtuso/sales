...
<html lang="[@T[localization:<language full='true' />]@T]" id="" ng-app="">
  <head>
    ...
    <title>[@L[cds.sales/getonline:ols-page-title]@L]</title>
    ...
    <atlantis:webstash type="js">
      <script>
        var offerInfo = {
          businessName: "",
          landingPage: "getonline/online-store.aspx",
          packageId: "getonline_online_store",
          itcCode: "p4p_getonline_store",
          appKey: "slp_GYBO",
          ...
          pricing: {
            ...
            promo_annual: "[@T[multipleproductprice:<current productidlist='464069|101|40972' period='yearly' promocode='75315678' />]@T]",
            renewal_monthly: "[@T[multipleproductprice:<list productidlist='464069|101|40972' period='monthly'></list>]@T]",
            renewal_annual: "[@T[multipleproductprice:<list productidlist='464069|101|40972' period='yearly'></list>]@T]"
          }
        };
      ...
      <div class="container"><img src="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/img-hero-guy.png" class="hero-guy hidden-xs">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-9 col-sm-offset-3 products">
            ...
            <div class="column website"><img src="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/img-features-onlineStore.png" class="img-responsive center-block">
              <h3 class="text-center">[@L[cds.sales/getonline:ols-product-name]@L]</h3>
              <p>[@L[cds.sales/getonline:ols-product-get-it-now-description]@L]</p>
            </div>
            <div class="plus">+</div>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-9 col-sm-offset-3 cta text-center">
            ...
            <button data-ci="96294" class="btn btn-purchase btn-lg center-block">[@L[cds.sales/getonline:get-it-now]@L]</button><small class="price-token">[@L[cds.sales/getonline:product-bundle-renewal-price]@L]</small>
            <div class="header-text disclaimers"><small class="text-disclaimers">[@L[cds.sales/getonline:top-small-disclaimer-text]@L] 
                <button data-ci="96983" class="btn-link see-details-disclaimer-link">[@L[cds.sales/getonline:top-small-disclaimer-details-link]@L]</button></small> 
        ...
        <div id="default-details-modal" data-title="[@L[cds.sales/getonline:disclaimer-modal-title]@L]" class="tokenizable-disclaimer-modal sf-dialog">
          <p>[@L[cds.sales/getonline:disclaimer-modal-ols-content]@L]</p>
        </div>
      </div>
    </section>
    <section id="domainSearchWizardSection" class="bg-primary-o">
      ...
      <div id="domain-available-view" style="[object Object]" class="js-domain-search-wizard-section">
        ...
        <div class="container other-domains spin-container">
          ...
          <div class="row show-more-section">
            <div class="col-md-12">
              <h6 style="[object Object]" class="text-center"><span data-ci="97024" class="clickable-show-more"><span>[@L[cds.sales/getonline:see-more-results]@L]</span><span class="show-more-arrow"></span></span></h6>
            </div>
          </div>
      ...
      <div id="domain-not-available-view" style="[object Object]" class="js-domain-search-wizard-section">
        ...
        <div class="container other-domains spin-container">
          ...
          <div class="row show-more-section">
            <div class="col-md-12">
              <h6 style="[object Object]" class="text-center"><span data-ci="97029" class="clickable-show-more"><span>[@L[cds.sales/getonline:see-more-results]@L]</span><span class="show-more-arrow"></span></span></h6>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="domain-selected-view" style="[object Object]" class="js-domain-search-wizard-section">
        <div id="selected-domain" class="container">
          ...
          <div style="[object Object]" class="row">
            <div class="col-xs-12 col-sm-12 text-center">
              <btn data-ci="97032" class="btn-search-again"><img src="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/img-search-glass.png"><span>[@L[cds.sales/getonline:search-again]@L]</span></btn>
            </div>
          </div>
          <div style="[object Object]" class="row">
            <div class="col-xs-12 col-sm-12 text-center">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-10 col-sm-offset-1"><img src="[@T[link:<imageroot />]@T]fos/sales/themes/montezuma/getonline/img/img-features-onlineStore.png" class="img-responsive center-block">
            <h2 class="text-center">[@L[cds.sales/getonline:ols-product-name]@L]</h2>
            <h4 class="text-center">[@L[cds.sales/getonline:ols-product-description]@L]</h4>
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div class="video-info col-sm-4">
                <div class="video-marquee-info text-center">
                  ...
                  <button id="watchVideo" style="[object Object]" data-toggle="modal" data-target="#g-modal" data-ci="96300" class="cta btn btn-default-dark btn-md uppercase">[@L[cds.sales/getonline:watch-now]@L]</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row bubble-row">
          ...
          <div class="col-xs-10 col-sm-8 col-lg-6 bubble">
            <mark class="uppercase">[@L[cds.sales/getonline:did-you-know]@L]</mark>
            <p>[@L[cds.sales/getonline:ols-product-did-you-know-text]@L]</p>
          </div>
        </div>
      </div>
    </section>

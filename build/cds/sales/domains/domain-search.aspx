...
<html lang="[@T[localization:<language full='true' />]@T]">
  <head>
    ...
    <style>
      ...
      #domain-promo {background-color: #77c043; }
      #why-godaddy {background-color: #d9d9d9; }
  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          <div style="padding-top:10px;" class="col-xs-12">
            <h4>Start your domain name search here</h4>
          </div>
        </div>
        <div class="row">
    ...
    <section id="domain-promo">
      <div class="container">
        <h2 class="text-center">It All Starts With A Domain Name.</h2>
        <div class="row">
          <div class="col-sm-6"><img src="[@T[link:<imageroot />]@T]fos/mike/img/hosting/GD_WebHosting_Module_Feature_Group_ScalableResources.png"></div>
          <div class="col-sm-6">
            <h3>Find Your Perfect Name</h3>
            <p>From classic domains like .com and .org to new domains like .menu, .repair, even .ninja (seriously), we can help you find the right name for your business.</p><a class="btn btn-default-dark">Get Started</a>
          </div>
        </div>
      </div>
    </section>
    <section id="why-godaddy">
      <div class="container">
        <h2 class="text-center">Why Choose A Domain Name From GoDaddy?</h2>
        <div class="row">
          <div class="col-sm-6">
            <div class="feature"><img src="data:image/svg+xml;base64,">
              <h3>World's Leading Domain Registrar</h3>
              <p>With over 12 million happy customers and 58 million domains under management, we know how to set you up for success online.</p>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="feature"><img src="[@T[link:<imageroot />]@T]fos/mike/img/hosting/GD_WebHosting_Module_Feature_Group_Security.png">
              <h3>More Names at Better Prices</h3>
              <p>We have 100s of domains to choose from.  And as the world's largest registrar, we can offer prices that other companies can only dream about.</p>
            </div>
          </div>
        </div>
      </div>

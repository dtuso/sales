...
<html lang="[@T[localization:<language full='true' />]@T]" id="ng-app" ng-app="dnsApp">
  <head>
    ...
    <meta property="fb:admins" content="633356800">[@P[webControl:<Data assembly="App_Code" type="WebControls.PresentationCentral.Item"><Parameters><Parameter key="Manifest" value="salesheader" /><Parameter key="Split" value="brand2.0" /><Parameter key="Name" value="css" /></Parameters></Data>]@P]
  ...
  <body ng-controller="dnsCtrl">
    <!-- HEADERBEGIN-->[@P[webControl:<Data assembly="App_Code" type="WebControls.PresentationCentral.Item"><Parameters><Parameter key="Manifest" value="salesheader" /><Parameter key="Split" value="brand2.0" /><Parameter key="Name" value="header" /></Parameters></Data>]@P]
    <!-- HEADEREND-->
    <section id="marquee">
    ...
    <section id="domainSearch">
      <div class="container">
        <h2>START YOUR DOMAIN SEARCH NOW.</h2>
    ...
    <section id="top-pods">
      <atlantis:webstash type="css">
        <style>
          ...
          #top-pods .plan-tile {margin-top: 0; }
...
top: -6px;
    ...
    <section id="what-do-you-get">
      <div class="container">
        <h2 class="text-center">[@L[cds.sales/gd/domains/domain-name-search:MainHeadingWhatDoYouGet]@L]</h2>
        <div class="row">
          <div class="col-sm-4">
            <ul class="green-check">
              <li>[@L[cds.sales/gd/domains/domain-name-search:WhatDoYouGetPointer1]@L]</li>
              <li>[@L[cds.sales/gd/domains/domain-name-search:WhatDoYouGetPointer2]@L]</li>
            </ul>
          </div>
          <div class="col-sm-4">
            <ul class="green-check">
              <li>[@L[cds.sales/gd/domains/domain-name-search:WhatDoYouGetPointer3]@L]</li>
              <li>[@L[cds.sales/gd/domains/domain-name-search:WhatDoYouGetPointer4]@L]</li>
            </ul>
          </div>
          <div class="col-sm-4">
            <ul class="green-check">
              <li>[@L[cds.sales/gd/domains/domain-name-search:WhatDoYouGetPointer5]@L]</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-10 col-sm-offset-1">
            <h2 class="text-center">[@L[cds.sales/gd/domains/domain-name-search:WhyGoDaddyMiscBannerTitle]@L]</h2>
            <p>[@L[cds.sales/gd/domains/domain-name-search:WhyGoDaddyMiscBannerTextRebrand]@L]</p>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4">
...
.dropdown li {
  font-family: Arial;
    ...
    <!-- FOOTERBEGIN-->[@P[webControl:<Data assembly="App_Code" type="WebControls.PresentationCentral.Item"><Parameters><Parameter key="Manifest" value="salesheader" /><Parameter key="Split" value="brand2.0" /><Parameter key="Name" value="footer" /></Parameters></Data>]@P]
    <!-- FOOTEREND-     -->
    <!-- liveperson includes -->

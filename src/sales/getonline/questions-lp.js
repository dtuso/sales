    ...
    function calculateResultsPage(){
      ...
      if(($('.dropdown1').val() == "new_business" || $('.dropdown1').val() == "existing_business")) {
        if($('.dropdown2').val() == "build_myself" && domainName != ""){
          ...
          resultPage += (resultPage.indexOf('?') > 0 ? '&' : '?') + 'domain=' + domainName + '&version=' + whiteListSpoof + '&version=sales/getonline/websitebuilder.aspx|54cbcadff778fc29c03a6679';
        
          window.location = resultPage;
        }
        else if($('.dropdown2').val() == "hire_someone"){
          //PRO SERVICES
        ...
        else if($('.dropdown2').val() == "know_someone"){
          //WEBSITE HOSTING 
      ...
      //--------------------BLOG--------------------------------------------------------
      else if($('.dropdown1').val() == "blog" && $('.dropdown2').val() == "build_myself"){
        //WORDPRESS
      ...
      else if($('.dropdown1').val() == "blog" && $('.dropdown2').val() == "hire_someone"){
        resultPage = '[@T[link:<relative path="~/getonline/wordpress.aspx"></relative>]@T]';
        resultPage += (resultPage.indexOf('?') > 0 ? '&' : '?') + 'domain=' + domainName + '&version=' + whiteListSpoof + '&version=sales/getonline/wordpress.aspx|54db8f88f778fc1120b67d32';
        
        window.location = resultPage;
      }
      else if($('.dropdown1').val() == "blog" && $('.dropdown2').val() == "know_someone"){
        resultPage = '[@T[link:<relative path="~/getonline/wordpress.aspx"></relative>]@T]';
        resultPage += (resultPage.indexOf('?') > 0 ? '&' : '?') + 'domain=' + domainName + '&version=' + whiteListSpoof + '&version=sales/getonline/wordpress.aspx|54db8f88f778fc1120b67d32';
      ...
      //------------SELLING PRODUCTS--------------------------------------------------
      else if($('.dropdown1').val() == "selling_products" && $('.dropdown2').val() == "build_myself"){
        //ONLINE STORE
      ...
      else if($('.dropdown1').val() == "selling_products" && $('.dropdown2').val() == "hire_someone"){
          //PRO SERVICES
      ...
      else if($('.dropdown1').val() == "selling_products" && $('.dropdown2').val() == "know_someone"){
